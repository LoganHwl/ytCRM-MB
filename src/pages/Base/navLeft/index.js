...
class navLeft extends Component {
  ...
  render() {
    ...
    return (
      <Drawer open={open} onClose={this.drawerClose}>
        <div className={`page ${style.nav}`}>
          ...
          <div className={style['nav-content']}>
            <p className="flex-row align-center">
              <img src={tagSrc} className="icon" alt="" />
              <span>个人标签：</span>
            </p>
            <div>
          ...
          <div className={style['nav-footer']}>
            <div className={style['nav-footer-body']}>
              <p className="flex-row align-center" onClick={this.updateUserInfo}>
                <img src={editSrc} className="icon" alt="" />
                <span>编辑</span>
              </p>
              <p className="flex-row align-center" onClick={this.logout}>
                <img src={logoutSrc} className="icon" alt="" />
                <span>退出登录</span>
              </p>
            </div>
          </div>
